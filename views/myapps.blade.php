...
@section('content')
  ...
  <div class="card-body">
    <h3 class="card-title"><font color="red">This Complete 5 in 1 Value packed Course <br>Is Going Out For Just ₦5,000.</font></h3>
    <p class="card-text">
...
<b>In the Mobile Games Creation Module, you’ll learn how to:</b>
<br>
